...
const OrdersDetailTable: React.FC<OrdersDetailTableProps> = ({ orders }) => {
        ...
        <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
          {orders.map((order) => (
            <tr key={order.id}>
              ...
              <td className="py-3 px-4 text-sm font-medium text-slate-900 dark:text-white">{order.buyer_name}</td>
              <td className="whitespace-nowrap py-3 px-4 text-sm font-semibold text-right text-slate-900 dark:text-white">
